...
class CurrencyAmountInputVisualTransformation(
    ...
    private class FixedCursorOffsetMapping(
        ...
        override fun writeToParcel(parcel: Parcel, flags: Int) {
            ...
            parcel.writeInt(formattedContentLength)
        }
        ...
        companion object CREATOR : Parcelable.Creator<FixedCursorOffsetMapping> {
            override fun createFromParcel(parcel: Parcel): FixedCursorOffsetMapping {
                return FixedCursorOffsetMapping(parcel)
            }

            override fun newArray(size: Int): Array<FixedCursorOffsetMapping?> {
